...
var fileDescriptor_15d485b4d7dd1f2e = []byte{
	...
	0xd7, 0x28, 0x98, 0x8b, 0x37, 0x18, 0xac, 0x33, 0x18, 0xa2, 0x4b, 0xc8, 0x89, 0x8b, 0x0d, 0x22,
	0x20, 0x24, 0xa5, 0x87, 0x61, 0xa6, 0x1e, 0x54, 0x9b, 0x14, 0x1e, 0x39, 0x25, 0x86, 0x24, 0x36,
	0xb0, 0x9b, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xa6, 0x12, 0x0c, 0x9f, 0xab, 0x00, 0x00,
	0x00,
}
...
func (c *squareServiceClient) Square(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/squarerpc_service.SquareService/Square", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedSquareServiceServer) Square(ctx context.Context, req *Message) (*Message, error) {
...
func _SquareService_Square_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SquareServiceServer).Square(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/squarerpc_service.SquareService/Square",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SquareServiceServer).Square(ctx, req.(*Message))
	}
...
var _SquareService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Square",
			Handler:    _SquareService_Square_Handler,
		},
	},
