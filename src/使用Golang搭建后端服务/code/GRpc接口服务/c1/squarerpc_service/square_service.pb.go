...
var fileDescriptor_15d485b4d7dd1f2e = []byte{
	...
	0xd7, 0x28, 0x8a, 0x8b, 0x37, 0x18, 0xac, 0x33, 0x18, 0xa2, 0x4b, 0xc8, 0x93, 0x8b, 0x3b, 0x28,
	0x31, 0x2f, 0x3d, 0x15, 0x22, 0x2a, 0x24, 0xa5, 0x87, 0x61, 0xb0, 0x1e, 0x54, 0xaf, 0x14, 0x1e,
	0x39, 0x25, 0x06, 0x03, 0xc6, 0x24, 0x36, 0xb0, 0xd3, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff,
	0x5c, 0x11, 0xef, 0x12, 0xb2, 0x00, 0x00, 0x00,
}
...
type SquareServiceClient interface {
	RangeSquare(ctx context.Context, in *Message, opts ...grpc.CallOption) (SquareService_RangeSquareClient, error)
}
...
func (c *squareServiceClient) RangeSquare(ctx context.Context, in *Message, opts ...grpc.CallOption) (SquareService_RangeSquareClient, error) {
	stream, err := c.cc.NewStream(ctx, &_SquareService_serviceDesc.Streams[0], "/squarerpc_service.SquareService/RangeSquare", opts...)
	if err != nil {
		return nil, err
	}
	x := &squareServiceRangeSquareClient{stream}
...
type SquareService_RangeSquareClient interface {
	Recv() (*Message, error)
	grpc.ClientStream
}

type squareServiceRangeSquareClient struct {
	grpc.ClientStream
}

func (x *squareServiceRangeSquareClient) Recv() (*Message, error) {
	m := new(Message)
...
type SquareServiceServer interface {
	RangeSquare(*Message, SquareService_RangeSquareServer) error
}
...
func (*UnimplementedSquareServiceServer) RangeSquare(req *Message, srv SquareService_RangeSquareServer) error {
...
func _SquareService_RangeSquare_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(Message)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(SquareServiceServer).RangeSquare(m, &squareServiceRangeSquareServer{stream})
}

type SquareService_RangeSquareServer interface {
	Send(*Message) error
	grpc.ServerStream
}

type squareServiceRangeSquareServer struct {
	grpc.ServerStream
}

func (x *squareServiceRangeSquareServer) Send(m *Message) error {
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _SquareService_RangeSquare_Handler,
			ServerStreams: true,
		},
	},
