...
<!-- TOC -->autoauto- [依赖控制](#依赖控制)auto    - [初始化项目](#初始化项目)auto    - [安装依赖](#安装依赖)auto    - [依赖控制](#依赖控制-1)auto    - [使用vendor本地化依赖](#使用vendor本地化依赖)auto    - [按版本项目发布](#按版本项目发布)auto    - [子模块](#子模块)auto    - [墙!](#墙)autoauto<!-- /TOC -->
